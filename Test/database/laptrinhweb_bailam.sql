...
CREATE TABLE `bailam` (
  `idbailam` int(100) unsigned NOT NULL,
  `idbaitap` int(100) unsigned NOT NULL,
  `cauhoi` varchar(100) NOT NULL,
  `cautraloi` varchar(100) NOT NULL,
  PRIMARY KEY (`idbailam`)
...
-- Dump completed on 2016-12-13 20:35:20
