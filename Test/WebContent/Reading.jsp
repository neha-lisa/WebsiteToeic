			...
			<div class="panel-heading">
				<div class="container">
					...
					<p align="justify">
						...
						A clean home (1)……….. rates <br> The Spick and Span Home
						Cleaning Service has come to your area. Spick and Span has
						developed a nationwide <br>reputation as the foremost <br>
						home cleaning service. <br> Our (2)………..agents are all
						carefully chosen and screened, so you don’t need to worry about
						whom you are letting<br> into your home. <br> Choose
						from five different cleaning plans, ranging from a once a month to
						a daily cleaning service. <br> You won’t find our agents
						(3)……….. : your home will be the cleanest it has ever been. <br>
						Call 1-800-556-5656 to find out more about our great rates and
						what we have to offer 10% discount to all new <br> customers
						(4)……….. throughout <br> March.
					...
					<form>
						...
						Affordable<br> <input type="radio" name="gender"
							...
							type="radio" name="gender" value="other">D. Reputable<br>
					</form>
					<br>
					<form>
						<p align="left">2.</p>
					...
					<form>
						...
						Cutting corners<br> <input type="radio" name="gender"
							...
							type="radio" name="gender" value="other">D. Putting off<br>
					</form>
					<br>
					<form>
						<p align="left">4.</p>
						...
						Registering<br> <input type="radio" name="gender"
							...
							type="radio" name="gender" value="other">D. Refunding<br>
					</form>
					<br>
									...
									<div id="id01" class="modal">
										...
										<form class="modal-content animate" action="action_page.php">
											...
											<div class="container" style="background-color:">
												<a href="Reading.jsp" class="btn btn-info" role="button">Again</a>
												<a href="Reading2.jsp" class="btn btn-info" role="button">Next</a>
