			...
			<div id="navbar" class="navbar-collapse collapse">
				...
				<div class="col-md-4">
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="active"><a href="index.jsp">Đăng Xuất<span
					...
					<nav class="navbar navbar-default" style="background: brown;">
						...
						<div class="navbar-collapse collapse" id="main-menu">
							<ul class="nav nav-justified ">
								<li><a class="textcolor" style="color: blue"
									href="HomeSauDangNhap.jsp"><strong>Home</strong></a></li>
								<li class="dropdown"><a style="color: blue"
							...
							<div class="panel-body">
								...
								<div class="col-md-8">
									<form id="FormGuiBai" method="post" class="form-horizontal"
										...
										<div class="form-group">
											<label for="tentacgia" class="col-sm-2">Chủ Đề</label>
											<div class="col-sm-10">
										...
										<div class="form-group">
											<label for="tentacgia" class="col-sm-2">Link</label>
											<div class="col-sm-10">
												<input type="text" class="form-control" id="Link"
													placeholder="Reading.jsp">
											</div>
										</div>
										<div class="form-group">
											<label for="noidung" class="col-sm-2">Đính kèm tệp</label>
											<div class="col-sm-10">
												<input type="file" id="tepdinhkem">
											</div>
										</div>
										<button class="btn btn-info" id="Share" style="width: auto;">Gửi</button>
									</form>
									<script>
                          ...
                          $(document).ready(
                            function()
                            {
                              $("#Share").click(function()
                              {
                                ...
                                if(!validateText("chude"))
                                  return false;

                                if(!validateText("noidung"))
                                  return false;
                                
                                if(!validateText("tepdinhkem"))
                                  return false;
