						...
						<div class="panel panel-info">
							<div class="panel-heading">
								<h3 class="panel-title">
									<strong>Quản Lý Tài Liệu</strong>
									
								</h3>
							</div>
							<div class="panel-body">
							<form action="chiasebaiviet.jsp" method="post">
							     <table class="table table-bordered table-hover">
							          ...
							          <tbody>
													...
													<c:forEach var="rows" items="${result.rows }">
														<tr>
														    <td>
														        <input type="hidden" value="${rows.ID_file_share }" name="id">
														    </td>
															<td>
															    <input type="text" value="${rows.ten_file }" name="tenfile">
															</td>
															<td>
															    <input type="text" value="${rows.ghichu }" name="ghichu">
															</td>
															<td>
															    <input type="text" value="${rows.share }" name="share">
															</td>									
														</tr>
													</c:forEach>
							     ...
							     <input type="submit" value="Chia Sẻ">
							     </form>
							</div>
