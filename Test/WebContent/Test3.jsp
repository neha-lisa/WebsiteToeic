		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="container">
					...
					<p align="left">Choose the word that best completes the
						sentence in the Part 5 TOEIC Test:</p>
					<br>
					<p align="justify">
						6. On weekends the Italian restaurant is often busy _________
					...
					<form>
						...
						All<br> <input type="radio" name="gender" value="female">B.
						Almost<br> <input type="radio" name="gender" value="other">C.
						Always<br> <input type="radio" name="gender" value="other">D.
						Everywhere<br>
					</form>
					<form>
						<p align="left">
							7. Forelli Media Inc. is an internationally ___________ marketing
							firm noted for its success throughout Europe, <br> East
							Asia, and the Americas.<br>

						</p>
						<input type="radio" name="gender" value="male" checked>A.
						Recognized<br> <input type="radio" name="gender"
							value="female">B. Recognizing<br> <input
							type="radio" name="gender" value="other">C. Recognize<br>
						<input type="radio" name="gender" value="other">D.
						Recognizes<br>
					</form>
					<br>
					<p align="left">
						8. More than 100 state-owned companies still remain __________ for
						privatization, according to the Privatization<br> Agency. <br>

					</p>
					<input type="radio" name="gender" value="male" checked>A.
					Available<br> <input type="radio" name="gender" value="female">B.
					Cooperative<br> <input type="radio" name="gender"
						value="other">C. common<br> <input type="radio"
						name="gender" value="other">D. Direct<br>
					</form>
					<br>
